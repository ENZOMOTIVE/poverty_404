...
export default function ReportsPage() {
  ...
  const statusDetail =
    status === "loading"
      ? "Agents are reading workbook metrics, building rationale, and preparing export data."
      : status === "ready"
        ? `Generated ${generatedAtLabel} with ${operationsCount} operational actions.`
        : status === "error"
          ? "The backend could not complete the report request."
          : backendStatus === "live"
            ? "Generate a current report before downloading HTML, JSON, or CSV files."
            : "Start the backend report service to generate and download reports.";
  const reportContents = [
    ...
    },
    {
      ...
      value: report
        ? `${formatNumber(report.agentResults.length)} agents`
        : "Pending",
    },
    {
      label: "Action queue",
    ...
    try {
      ...
      setError(
        caught instanceof Error
          ? caught.message
          : "Detailed report backend unavailable",
      );
    }
  }
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        kicker="Agent generated export"
        title="Detailed reports"
        description="Generate a downloadable operations report from current workbook metrics, agent findings, action queues, charts, and exportable data tables."
      >
      ...
      <Panel
        ...
        subtitle="Exports are generated by the backend report agent from the loaded workbook dataset."
        action={
        ...
        <>
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {[
              ...
              ["Narrative", report.usedLLM ? "LLM assisted" : "Rule-based"],
            ].map(([label, value]) => (
              <div
                key={label}
          ...
          <Panel
            title="Operations in report"
            subtitle="Current follow-up actions included in all downloads."
          >
